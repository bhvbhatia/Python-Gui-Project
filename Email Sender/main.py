    ...
    if '@gmail.com' not in e or e == "":
        ...
        messagebox.showerror('Login error', "Password Shouldn't be Empty ")
          ...
          try:
              ...
              send = Button(root, text="Send", padx=30, relief=RIDGE, borderwidth=1, bg="orange", font=('verdana', 10, 'bold'),
...
h1 = Label(root, text="Email Sender", bg="orange", fg="black", font= ('verdana0', 13, 'bold'))
h1.place(x=135,y=5)
